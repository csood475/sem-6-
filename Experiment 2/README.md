...
A professional, high-performance React application designed to showcase a career focused on **Data Science**, **Analytical Dashboards**, and **Machine Learning Research**.

This project features a metrics-driven UI that highlights technical impact, academic contributions, and data-driven decision making.
...
src/
├── components/
│   ├── DataHero.jsx          # Intro with performance metrics
│   ├── SkillDashboard.jsx   # Data tool proficiency bars
│   ├── ResearchTimeline.jsx # Publication timeline (MUI Lab)
│   └── ProjectAnalytics.jsx # Metrics-focused project cards
├── App.jsx                  # Main layout controller
├── App.css                  # Slate Blue & Teal theme
└── index.css                # Full-screen layout resets
```
## 📦 Installation & Setup
